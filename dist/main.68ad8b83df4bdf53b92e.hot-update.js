...
.main__image::before {
  ...
  height: 55.8125rem;
  border-radius: 50%;
  background: linear-gradient(rgba(255, 255, 255, 0.05) 30%, rgba(255, 255, 255, 0.6) 50%, rgba(255, 255, 255, 0.05) 70%);
}
